...
test('Family Vault - PDF upload, download, and cleanup', async ({ page }) => {
  const loginPage = new LoginPage(page);
  const vaultPage = new VaultPage(page);

  const testFileName = 'FamilyVault_Test_PDF.pdf';
  ...
  console.log('========================================');
  console.log('FAMILY VAULT PDF TEST');
  console.log('========================================');
