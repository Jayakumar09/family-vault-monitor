...
test('Family Vault - Word upload, download, and cleanup', async ({ page }) => {
  const loginPage = new LoginPage(page);
  const vaultPage = new VaultPage(page);

  const testFileName = 'FamilyVault_Test_Word.docx';
  ...
  console.log('========================================');
  console.log('FAMILY VAULT WORD TEST');
  console.log('========================================');
  ...
  console.log('Word upload: PASS');

  // -----------------------------------------
  // Step 4: Verify Word document
  // -----------------------------------------
  ...
  console.log(
    `Word document visible: ${testFileName} — PASS`,
  );
