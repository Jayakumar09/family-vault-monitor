...
test('Family Vault - Excel upload, download, and cleanup', async ({ page }) => {
  const loginPage = new LoginPage(page);
  const vaultPage = new VaultPage(page);

  const testFileName = 'FamilyVault_Test_Excel.xlsx';
  ...
  console.log('========================================');
  console.log('FAMILY VAULT EXCEL TEST');
  console.log('========================================');
  ...
  console.log(
    `Excel document visible: ${testFileName} — PASS`,
  );
  ...
  console.log('----------------------------------------');
  console.log('EXCEL TEST: HEALTHY');
  console.log('----------------------------------------');
});