  ...
  async verifyDocumentPresent(
    ...
    await expect(
      ...
      timeout: 30000,
            ...
            const document = this.page.getByText(
            fileName,
            { exact: true },
            );
            ...
            const deleteMenuItem = this.page.getByRole(
            'menuitem',
            {
                name: 'Delete',
                exact: true,
            ...
            const deleteDialog = this.page.getByRole(
            'dialog',
            );
            ...
            console.log('Delete confirmation dialog: PASS');

            // We will inspect the confirmation button
